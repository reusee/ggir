...
var (
	...
	CREDENTIALS_TYPE_NETBSD_UNPCBID       = C.GCredentialsType(C.G_CREDENTIALS_TYPE_NETBSD_UNPCBID)
	...
	NOTIFICATION_PRIORITY_NORMAL = C.GNotificationPriority(C.G_NOTIFICATION_PRIORITY_NORMAL)
	NOTIFICATION_PRIORITY_LOW    = C.GNotificationPriority(C.G_NOTIFICATION_PRIORITY_LOW)
	NOTIFICATION_PRIORITY_HIGH   = C.GNotificationPriority(C.G_NOTIFICATION_PRIORITY_HIGH)
	NOTIFICATION_PRIORITY_URGENT = C.GNotificationPriority(C.G_NOTIFICATION_PRIORITY_URGENT)
